...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-[#1C2A39] py-32 lg:py-40">
        <div className="container mx-auto px-6">
          <div className="mx-auto max-w-5xl">
            <h1 className="font-serif text-5xl font-light leading-tight tracking-tight text-[#FAF9F6] sm:text-6xl lg:text-7xl">
              Guided by Intuition.
              <br />
              Defined by Results.
            </h1>
            <p className="mt-8 font-sans text-xl font-light leading-relaxed text-[#FAF9F6]/70 lg:text-2xl">
        ...
        <div className="container mx-auto px-6">
          <div className="mx-auto max-w-4xl">
            <div className="space-y-8">
              <p className="font-sans text-xl font-light leading-relaxed text-[#1C2A39]/80 lg:text-2xl">
      ...
      {/* By the Numbers */}
      <section className="border-y border-[#1C2A39]/10 bg-white py-24">
        <div className="container mx-auto px-6">
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-12 md:grid-cols-3 lg:gap-16">
              <div className="text-center">
                <div className="font-serif text-6xl font-light text-[#C5A059] lg:text-7xl">
                  12+
                </div>
                <div className="mt-4 font-sans text-base font-light uppercase tracking-[0.2em] text-[#1C2A39]/60">
                  Years in Atlanta
                </div>
              </div>
              <div className="text-center">
      ...
      <section className="py-24 lg:py-32">
        <div className="container mx-auto px-6">
          <div className="mx-auto max-w-4xl">
            <h2 className="mb-12 font-serif text-4xl font-light text-[#1C2A39] lg:text-5xl">
              The Philosophy
            </h2>
            <div className="space-y-8">
              <p className="font-sans text-xl font-light leading-relaxed text-[#1C2A39]/80 lg:text-2xl">
      ...
      <section className="bg-[#1C2A39] py-24 lg:py-32">
        <div className="container mx-auto px-6">
          <div className="mx-auto max-w-4xl">
            <h2 className="mb-12 font-serif text-4xl font-light text-[#FAF9F6] lg:text-5xl">
              Off the Clock
            </h2>
            <div className="space-y-8">
              <p className="font-sans text-xl font-light leading-relaxed text-[#FAF9F6]/80 lg:text-2xl">
      ...
      <section className="relative h-[60vh] min-h-[500px]">
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#1C2A39]/60 to-transparent" />
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="grid gap-12 md:grid-cols-2">
              <div>
                <h3 className="mb-4 font-sans text-xl font-medium text-[#1C2A39]">
                  For Buyers
                </h3>
      ...
      {/* CTA Section */}
      <section className="border-t border-[#1C2A39]/10 bg-white py-24">
        <div className="container mx-auto px-6">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="mb-6 font-serif text-4xl font-light text-[#1C2A39] lg:text-5xl">
              Let's Begin
            </h2>
            <p className="mb-10 font-sans text-xl font-light leading-relaxed text-[#1C2A39]/80">
