      ...
      <div className="relative z-10 mx-auto max-w-7xl px-8 lg:px-12">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <motion.div
            ...
            className="group relative overflow-hidden rounded-lg border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition-all duration-300 hover:border-cerulean hover:bg-white/10"
          >
            <div className="relative z-10">
              <div className="font-serif text-5xl text-bronze lg:text-6xl">
            ...
            {/* Decorative gradient */}
            <div className="absolute inset-0 bg-gradient-to-br from-cerulean/10 to-transparent opacity-0 transition-opacity group-hover:opacity-100" />
          </motion.div>
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-8">
            {siteConfig.awards.map((award, index) => (
              ...
              >
                <svg className="h-5 w-5 text-bronze" fill="currentColor" viewBox="0 0 20 20">
