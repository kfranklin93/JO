...
export function FeaturedListings() {
  return (
    <section className="bg-[#FAF9F6] py-32 sm:py-40">
      <div className="mx-auto max-w-7xl px-8 lg:px-12">
        ...
        <div className="mt-16 text-center">
          <Link
            href="/properties"
            className="inline-flex items-center justify-center gap-3 rounded-2xl border border-[#1C2A39]/20 bg-transparent px-10 py-5 font-sans text-base font-normal text-[#1C2A39] transition-all duration-300 hover:border-[#C5A059] hover:bg-[#C5A059] hover:text-[#FAF9F6]"
          >
