    ...
    <section ref={heroRef} className="relative min-h-screen overflow-hidden bg-black">
      ...
      >
        <Image
          ...
          quality={90}
        />
        {/* JOEY UPDATE: Gradient overlay for text readability */}
        ...
        <div className="mx-auto w-full max-w-5xl">
          ...
          >
            <p className="font-sans text-lg text-white/80">
              <span className="font-medium text-white">{siteConfig.fullName}</span>
              {' • '}
              {siteConfig.subtitle}
            </p>
            <div className="mt-4 flex flex-wrap items-center justify-center gap-6">
              <a
                ...
                className="flex items-center gap-2 font-sans text-white/90 transition-colors hover:text-accent"
              >
