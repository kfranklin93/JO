      ...
      <div className="mx-auto max-w-7xl px-8 lg:px-12">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {clientTestimonials.map((testimonial, index) => (
            ...
            >
              ...
              <blockquote className="mt-6 flex-grow font-sans text-base leading-relaxed text-neutral-700">
                "{testimonial.content}"
              </blockquote>
              ...
              <div className="mt-6 flex items-center gap-4 border-t border-neutral-200 pt-6">
                ...
                <div>
                  <p className="font-sans text-sm font-medium text-black">{testimonial.name}</p>
                  <p className="font-sans text-xs text-neutral-600">{testimonial.role}</p>
                  {testimonial.location && (
                    <p className="font-sans text-xs text-neutral-500">{testimonial.location}</p>
                  )}
                </div>
              </div>
              ...
              <div className="absolute right-8 top-8 opacity-10 transition-opacity group-hover:opacity-20">
                <svg className="h-12 w-12 text-accent" fill="currentColor" viewBox="0 0 32 32">
        ...
        >
          <div className="grid gap-8 sm:grid-cols-3">
            <div>
              <div className="font-serif text-4xl text-accent">60+</div>
              <div className="mt-2 font-sans text-sm uppercase tracking-wider text-neutral-600">Homes Sold</div>
            </div>
            <div>
              <div className="font-serif text-4xl text-accent">$23.9M</div>
              <div className="mt-2 font-sans text-sm uppercase tracking-wider text-neutral-600">Total Volume</div>
            </div>
            <div>
              <div className="font-serif text-4xl text-accent">5.0</div>
              <div className="mt-2 font-sans text-sm uppercase tracking-wider text-neutral-600">Average Rating</div>
            </div>
          </div>
        </motion.div>
      </div>
