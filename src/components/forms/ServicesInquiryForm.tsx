          ...
          >
            ...
            <div className="max-h-[85vh] overflow-y-auto p-8 sm:p-12">
              {step === 'service' && (
                ...
                >
                  <h2 id="modal-title" className="font-serif text-3xl text-black sm:text-4xl">
                    How Can I Help You?
                  </h2>
                  ...
                  <div className="mt-8 grid gap-4 sm:grid-cols-2">
                    <button
                      ...
                      className="group flex flex-col items-start rounded-lg border-2 border-neutral-200 bg-white p-6 text-left transition-all hover:border-primary hover:shadow-lg focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
                    >
                      <svg className="h-8 w-8 text-neutral-400 transition-colors group-hover:text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                      </svg>
                      <h3 className="mt-4 font-serif text-xl text-black">Buying a Home</h3>
                      <p className="mt-2 font-sans text-sm text-neutral-600">Find your perfect property in Atlanta</p>
                    </button>
                    ...
                    >
                      ...
                      <h3 className="mt-4 font-serif text-xl text-black">Selling a Home</h3>
                      <p className="mt-2 font-sans text-sm text-neutral-600">Get top dollar for your property</p>
                    </button>
                    ...
                    >
                      ...
                      <h3 className="mt-4 font-serif text-xl text-black">Buying & Selling</h3>
                      <p className="mt-2 font-sans text-sm text-neutral-600">Seamless transition to your next home</p>
                    </button>
                    ...
                    >
                      ...
                      <h3 className="mt-4 font-serif text-xl text-black">General Question</h3>
                      <p className="mt-2 font-sans text-sm text-neutral-600">Ask me anything about real estate</p>
                    </button>
                  </div>
                </motion.div>
              )}
              ...
              {step === 'details' && (
                ...
                >
                  ...
                  <button
                    ...
                    className="mb-6 flex items-center gap-2 font-sans text-sm text-neutral-600 transition-colors hover:text-black"
                  >
