                ...
                >
                  ...
                  <div className="mt-8 grid gap-4 sm:grid-cols-2">
                    <button
                      ...
                      className="group flex flex-col items-start rounded-lg border-2 border-neutral-200 bg-white p-6 text-left transition-all hover:border-cerulean hover:shadow-lg focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cerulean"
                    >
                      <svg className="h-8 w-8 text-neutral-400 transition-colors group-hover:text-cerulean" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
