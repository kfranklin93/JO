            ...
            >
              <div className="flex w-full items-center">
                ...
                <div
                  className={cn(
                    ...
                    (isPast || isCompleted) && !isCurrent && 'border-navy bg-navy text-white',
                    !isCurrent && !isPast && !isCompleted && 'border-navy/20 bg-linen text-stone'
                  )}
              ...
              <span
                className={cn(
                  ...
                  isCurrent ? 'text-navy' : 'text-stone'
                )}
              >
                {label}
              </span>
